...
ap.add_argument("-w", "--weights", default="/Users/parthjindal/Downloads/Real-time-Object-Detection-for-Autonomous-Driving-using-Deep-Learning-main/YOLO/Training YOLO/YOLO_bdd100k.pt", help="path to the modell weights")
...
ap.add_argument("-i", "--input", default="/Users/parthjindal/Downloads/Real-time-Object-Detection-for-Autonomous-Driving-using-Deep-Learning-main/YOLO/Inference YOLO/a.jpg" , help="path to your input image")
ap.add_argument("-o", "--output",default="/Users/parthjindal/Downloads/Real-time-Object-Detection-for-Autonomous-Driving-using-Deep-Learning-main/YOLO/Inference YOLO/cb2fe290-8786cd14_o.jpg" , help="path to your output image")
args = ap.parse_args()
